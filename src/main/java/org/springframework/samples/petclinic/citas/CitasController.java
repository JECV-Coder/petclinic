...
public class CitasController {
    ...
    public CitasController(CitasRepository clinicService, EspecialidadesRepository especialidadesRepository,MascotasRepository mascotasRepository,CitaHistoryRepository citaHistory) {
        this.citas = clinicService;
        this.especialidadesRepository = especialidadesRepository;
        this.mascotasRepository = mascotasRepository;
        this.citaHistory = citaHistory;
    }
    ...
    public String citaFormAdmin(Map<String, Object> model,Owner owner) {
       ...
       // model.put("owners", results);
        ...
        Collection<CitaHistory> allCitas = this.citaHistory.getAllCitas();
        model.put("allCitas", allCitas);
